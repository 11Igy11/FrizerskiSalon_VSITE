...
namespace FrizerskiSalon_VSITE.Migrations
{
    ...
    [Migration("20250126201843_AddServiceToReservation")]
    partial class AddServiceToReservation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FrizerskiSalon_VSITE.Models.User", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("FrizerskiSalon_VSITE.Models.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
